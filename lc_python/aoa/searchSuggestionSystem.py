...
#   Output: [["havana"], ["havana"], ["havana"],
#          ["havana"], ["havana"], ["havana"]]
#
# Example 3:
#   Input: products = ["bags", "baggage", "banner", "box", "cloths"], searchWord = "bags"
#   Output: [["baggage", "bags", "banner"], ["baggage",
#                                          "bags", "banner"], ["baggage", "bags"], ["bags"]]
#
# Example 4:
...
searchWord = "mouse"
solution =  [["mobile", "moneypot", "monitor"],
             ["mobile", "moneypot", "monitor"],
             ["mouse", "mousepad"],
             ["mouse", "mousepad"],
             ["mouse", "mousepad"]]
output = s.getSearchSuggestion(products, searchWord)
